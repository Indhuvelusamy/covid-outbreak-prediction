...
def home(request):
    ...
    workbook1 = xlrd.open_workbook("D:\\indhu college\\miniproject-2\\covid\\tamilnadu_vaccine.xls");
    sheet1=workbook1.sheet_by_index(0)
    n=sheet1.nrows
...
def charts(request):
    ...
    months=' '.join(months)
    #y=[130068,58494,36572,20755,13231,33031,263970,920516,406610,84418,55275]
    y=[84418,55275,48917]
    x=[-1,0,1]
    a=sum(y)/3
    xy=[y[i]*x[i] for i in range(len(y))]
    ...
    v=int(v)
    print("todays expected count",v)
    return render(request,"charts.html",{'x':val,'y':m,'month':v})
...
def district_wise(request):
    ...
    print(r)'''
    import xlrd
    workbook = xlrd.open_workbook("D:\\indhu college\\miniproject-2\\districtwise.xls");
    sheet = workbook.sheet_by_index(0)
    col=sheet.cell_value(0, 0)
    rows=sheet.nrows
    #print(sheet.cell_value(22, 6))
...
def statewise(request):
    ...
    for i in range(len(r)):
        ...
        print(r[i])'''
    import xlrd
    workbook = xlrd.open_workbook("D:\\indhu college\\miniproject-2\\statewise.xls");
    sheet = workbook.sheet_by_index(0)
    col=sheet.cell_value(0, 0)
    rows=sheet.nrows
    #print(sheet.cell_value(22, 6))
